...
#define EXTI_LINE_14						14				//Posible uso para control de ZCD de VBUS para heaters
...
#define BOARD_ZCD_VBUS_SELECT				EXTI_LINE_14	//Posible uso para control de ZCD de VBUS para heaters
...
#define BOARD_HEATER_1_PIN						GPIO3
#define BOARD_HEATER_1_PORT						GPIOA
#define BOARD_HEATER_2_PIN						GPIO11
#define BOARD_HEATER_2_PORT						GPIOB
#define BOARD_ZCD_LINE_PIN						GPIO14
#define BOARD_ZCD_LINE_PORT						GPIOA
...
#define GPIO_PIN_0_HIZ							(1<<GPIO0)
#define GPIO_PIN_1_HIZ							(1<<GPIO1)
#define GPIO_PIN_2_HIZ							(1<<GPIO2)
#define GPIO_PIN_3_HIZ							(1<<GPIO3)
#define GPIO_PIN_4_HIZ							(1<<GPIO4)
#define GPIO_PIN_5_HIZ							(1<<GPIO5)
#define GPIO_PIN_6_HIZ							(1<<GPIO6)
#define GPIO_PIN_7_HIZ							(1<<GPIO7)
#define GPIO_PIN_8_HIZ							(1<<GPIO8)
#define GPIO_PIN_9_HIZ							(1<<GPIO9)
#define GPIO_PIN_10_HIZ							(1<<GPIO10)
#define GPIO_PIN_11_HIZ							(1<<GPIO11)
#define GPIO_PIN_12_HIZ							(1<<GPIO12)
#define GPIO_PIN_13_HIZ							(1<<GPIO13)
#define GPIO_PIN_14_HIZ							(1<<GPIO14)
#define GPIO_PIN_15_HIZ							(1<<GPIO15)

#define GPIO_PIN_0_IN_PULLUP					(1<<GPIO0)
#define GPIO_PIN_1_IN_PULLUP					(1<<GPIO1)
#define GPIO_PIN_2_IN_PULLUP					(1<<GPIO2)
#define GPIO_PIN_3_IN_PULLUP					(1<<GPIO3)
#define GPIO_PIN_4_IN_PULLUP					(1<<GPIO4)
#define GPIO_PIN_5_IN_PULLUP					(1<<GPIO5)
#define GPIO_PIN_6_IN_PULLUP					(1<<GPIO6)
#define GPIO_PIN_7_IN_PULLUP					(1<<GPIO7)
#define GPIO_PIN_8_IN_PULLUP					(1<<GPIO8)
#define GPIO_PIN_9_IN_PULLUP					(1<<GPIO9)
#define GPIO_PIN_10_IN_PULLUP					(1<<GPIO10)
#define GPIO_PIN_11_IN_PULLUP					(1<<GPIO11)
#define GPIO_PIN_12_IN_PULLUP					(1<<GPIO12)
#define GPIO_PIN_13_IN_PULLUP					(1<<GPIO13)
#define GPIO_PIN_14_IN_PULLUP					(1<<GPIO14)
#define GPIO_PIN_15_IN_PULLUP					(1<<GPIO15)
