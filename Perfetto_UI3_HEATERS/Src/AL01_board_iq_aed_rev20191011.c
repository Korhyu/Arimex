...
void board_hardware_configuration (void)
{
	...
	board_hardware_gpio_config_hiz_pins_load_config		   		(GPIOA, GPIO_PIN_6|GPIO_PIN_14|GPIO_PIN_15);
	...
	board_hardware_gpio_config_inputs_pins_load_config	   		(GPIOA, GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_14);
	
	//Idem para GPIOBx
	board_hardware_gpio_config_output_pp_pins_load_config		(GPIOB, GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_6|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_13|GPIO_PIN_14);
	...
	//GPIOAx Como "Open Drain" / HiZ
	board_hardware_gpio_config_hiz_pins_load_config		   		(GPIOA, GPIO_PIN_15);
	//GPIOAx Como deteccion(irq) en flancos
	board_hardware_gpio_config_edge_events_pins_load_config		(GPIOA, 0);
	//GPIOAx Como entradas logicas
