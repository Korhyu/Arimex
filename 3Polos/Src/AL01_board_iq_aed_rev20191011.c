...
void board_hardware_configuration (void)
{
	...
	board_hardware_gpio_config_output_pp_pins_load_config  		(GPIOA, GPIO_PIN_0|GPIO_PIN_3|GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_11|GPIO_PIN_15);
	...
	//Idem para GPIOBx
	board_hardware_gpio_config_output_pp_pins_load_config		(GPIOB, GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_6|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_14);
	board_hardware_gpio_config_hiz_pins_load_config				(GPIOB, GPIOB_PIN_13_HIZ);
	...
	//Idem para GPIOCx
	board_hardware_gpio_config_output_pp_pins_load_config		(GPIOC, GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_6|GPIO_PIN_7);
	board_hardware_gpio_config_hiz_pins_load_config				(GPIOC, GPIOC_PIN_0_HIZ);
	board_hardware_gpio_config_edge_events_pins_load_config		(GPIOC, 0);
	board_hardware_gpio_config_inputs_pins_load_config			(GPIOC, 0);
