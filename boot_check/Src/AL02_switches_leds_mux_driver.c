 ...
 */
void ui_led_slide (int8_t control, int8_t modificador)
{
	uint8_t led_aux;
 ...
 * Funcion que lee el estado de LEDs y realiza el cambio necesario
 * control: UI_FAN o UI_HEATER - Modifica los leds del Fan o el Calefactor
 * value: es el valor del control final que debe quedar
 */
void ui_led_force (int8_t control, int8_t value)
{
	uint8_t led_aux;
	...
	if (control == UI_FAN)
	{
		...
		case UI_SPEED_1:
			led_aux = leds_state & 0b00001111;
			break;

		case UI_SPEED_2:
			led_aux = leds_state & 0b00011111;
			break;

		case UI_SPEED_3:
			led_aux = leds_state & 0b00111111;
			break;
	...
	else if ( control == UI_HEATER )
	{
		...
		case UI_HEATER_0:
			led_aux = leds_state & 0b00111000;
			break;

		case UI_HEATER_1:
			led_aux = leds_state & 0b00111001;
			break;

		case UI_HEATER_2:
			led_aux = leds_state & 0b00111011;
			break;
