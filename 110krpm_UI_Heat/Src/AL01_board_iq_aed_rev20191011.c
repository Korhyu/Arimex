...
void board_hardware_configuration (void)
{
	...
	board_hardware_gpio_config_inputs_pins_load_config	   		(GPIOA, GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_14);		//UI_IO_6/3 - Entrada zcd de senoidal entrada
	...
	board_hardware_gpio_config_hiz_pins_load_config				(GPIOC, GPIOC_PIN_0_HIZ);		//Coldshot
