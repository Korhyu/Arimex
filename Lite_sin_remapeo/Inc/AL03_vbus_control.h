...
#define VBUS_HIGH_MIN_TH				2850		//Valor minimo de VBUS con ROC para pasar a alta velocidad - 2.392V medido
#define VBUS_LOW_MIN_TH					2750		//Valor minimo de VBUS con RMO para pasar a baja velocidad - 2.3V medido
#define VBUS_VERY_LOW_MIN_TH			2450		//Valor minimo de VBUS con RMO para pasar a baja velocidad - estimado
