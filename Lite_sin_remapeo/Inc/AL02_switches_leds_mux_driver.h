...
#define UI_SPEED_1			1			//Velocidad 1, 2 y 3
#define UI_SPEED_2			2
#define UI_SPEED_3			3

#define UI_HEATER_0			0			//Heater apagado, 1, 2 y 3
#define UI_HEATER_1			1
#define UI_HEATER_2			2
#define UI_HEATER_3			3
...
void		ui_led_slide				(int8_t, int8_t);
void		ui_led_force				(int8_t, int8_t);
