...
static void micro_adc_config(void)
{
	...
	AFIO_GPxConfig(GPIO_PB, AFIO_PIN_7, AFIO_FUN_ADC);			//Shunt AVG measure
	AFIO_GPxConfig(GPIO_PB, AFIO_PIN_8, AFIO_FUN_ADC);			//Vbus measure
	AFIO_GPxConfig(GPIO_PA, AFIO_PIN_1, AFIO_FUN_ADC);			//NTC potencia
