...
#define PWM_OPERATING_TON_uS								50
#define PWM_OPERATING_DUTY									70

/*Configuracion de PWM que se va a usar enregimen permanente */
#define PWM_OPERATING_DUTY_PER								68

#define ZCD_FRACTION_ADVANCE_START							0.31		//Porcentaje de zcd_to_zcd de avance para desde el arranque
...
#define SET_POINT_PWM_DUTY_UPDATE_TIME_mS		  		4		//Intervalo en milisegundos en que se modifica el duty del PWM
...
{
	motor_3phase_set_pwm_duty_set_point(set_point);
}
