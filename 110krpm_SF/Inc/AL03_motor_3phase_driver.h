...
//Dutys umbrales para cambiar la cantidad de pulsos del PWM
//TODO: Estos valores hay que actualizarlos cuando se hagan las mediciones de las velocidades
#define MOTOR_1_PULSE_DUTY_MIN			70		//Duty minimo al cual el PWM pasa a tener 1 pulso por secuencia
#define MOTOR_3_PULSE_DUTY_MIN			60		//Duty minimo al cual el PWM pasa a tener 3 pulsos por secuencia
#define MOTOR_5_PULSE_DUTY_MIN			50		//Duty minimo al cual el PWM pasa a tener 5 pulsos por secuencia


//Periodos de seq para las diferentes velocidades
#define MOTOR_MAX_SPEED_SEQ_PERIOD		570		//Velocidad 105000 rpm - 1750 Hz - 570us periodo - 95us SEQ
#define MOTOR_MID_SPEED_SEQ_PERIOD		660		//Velocidad  90000 rpm - 1500 Hz - 660us periodo - 110us SEQ
#define MOTOR_MIN_SPEED_SEQ_PERIOD		860		//Velocidad  70000 rpm - 1160 Hz - 860us periodo - 140us SEQ


#define MAX_VECTOR_LENGTH				6		//Profundidad del vector para promedios
...
struct motor_3phase_drive{
	...
	int32_t motor_electrical_period_vector[MAX_VECTOR_LENGTH];

	int32_t motor_electrical_period_us_avg;
	int32_t motor_electrical_period_us_sp;		//set point del periodo electrico
