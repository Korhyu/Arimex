...
#define __hardware_pwm_end_toff_disable_irq()				{TM_IntConfig(HT_MCTM0,TM_INT_CH3CC,DISABLE); 		TM_ClearFlag(HT_MCTM0,TM_INT_CH3CC);}
#define __hardware_pwm_end_toff_enable_irq()				{TM_IntConfig(TM_ClearFlag(HT_MCTM0,TM_INT_CH3CC); 	HT_MCTM0,TM_INT_CH3CC,ENABLE);}
