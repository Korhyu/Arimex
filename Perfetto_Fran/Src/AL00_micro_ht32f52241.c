...
{
		TM_SetCaptureCompare(HT_MCTM0,TM_CH_0,((toff_us<pwm_time_before_ton_start_us) ? pwm_time_before_ton_start_us : toff_us));
		TM_SetCaptureCompare(HT_MCTM0,TM_CH_1,((toff_us<pwm_time_before_ton_start_us) ? pwm_time_before_ton_start_us : toff_us));
		TM_SetCaptureCompare(HT_MCTM0,TM_CH_3,((toff_us<pwm_time_before_ton_start_us) ? pwm_time_before_ton_start_us : toff_us));
	
		TM_SetCaptureCompare(HT_MCTM0,TM_CH_2,((toff_us<pwm_time_before_ton_start_us) ? 1 : toff_us-pwm_time_before_ton_start_us+1));
